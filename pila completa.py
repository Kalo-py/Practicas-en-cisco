...
print(objetoPila._SumarPila__pito)
...
print("Variable privada= ",end="")
print(objetoPila._Pila__vai) #otro ejemplo es recordar que para llamar a una variable superior es poner _Pila__vai
